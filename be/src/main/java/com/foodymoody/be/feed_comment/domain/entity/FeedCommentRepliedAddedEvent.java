...
@Getter
public class FeedCommentRepliedAddedEvent implements NotificationEvent {
    ...
    private FeedCommentRepliedAddedEvent(
    ...
    public static FeedCommentRepliedAddedEvent of(
            FeedCommentId feedCommentId,
            Content commentContent,
            MemberId toMemberId,
            FeedId feedId,
        ...
        return new FeedCommentRepliedAddedEvent(
                feedCommentId,
                commentContent,
                toMemberId,
                feedId,
