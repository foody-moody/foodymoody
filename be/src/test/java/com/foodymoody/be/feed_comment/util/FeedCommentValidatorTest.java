...
class FeedCommentValidatorTest {
    ...
    @BeforeEach
    void setUp() {
        feedCommentId = FeedCommentFixture.feedCommentId();
        content = FeedCommentFixture.content();
        memberId = FeedCommentFixture.memberId();
        createdAt = FeedCommentFixture.newLocalTime();
        feedId = FeedCommentFixture.feedId();
    }
