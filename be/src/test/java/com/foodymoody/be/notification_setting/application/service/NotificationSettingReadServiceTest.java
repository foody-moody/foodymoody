...
class NotificationSettingReadServiceTest {

    @InjectMocks
    private NotificationSettingReadService notificationSettingReadService;
    ...
    void fetchByMemberId() {
        ...
        given(notificationSettingRepository.findSummaryByMemberId(memberId)).willReturn(Optional.empty());
