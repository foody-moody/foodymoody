...
public class FeedLikeSteps {
    ...
    public static ExtractableResponse<Response> 좋아요를_한다(String feedId, String accessToken) {
        return 좋아요를_한다(feedId, accessToken, new RequestSpecBuilder().build());
    }
    ...
    public static ExtractableResponse<Response> 좋아요된_피드에_또_좋아요를_한다(
    ...
    public static ExtractableResponse<Response> 좋아요_한_적이_없는데_좋아요_취소를_한다(
            String feedId, String accessToken,
            RequestSpecification spec
    ) {
        Map<String, Object> body = Map.of(
